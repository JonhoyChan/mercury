...
var (
	errRepoExists = ecode.NewError(`ipfs configuration file already exists!
Reinitializing would overwrite your keys.
`)
	errRepoLock = ecode.NewError(`this repo is currently being accessed by another process
...
func doInit(out io.Writer, repoRoot string, empty bool, nBitsForKeypair int, confProfiles string, conf *config.Config) error {
	...
	if conf == nil {
		...
		// mercury uses different default addresses
