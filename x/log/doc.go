...
JSON instead if that suits you. Here's how you log:
    ...
    log.Info("page accessed", "path", r.URL.Path, "user_id", account.id)
...
or above in JSON formatted output to the file /var/log/service.json
    ...
    handler := log.MultiHandler(
        ...
        log.MatchFilterHandler("pkg", "wechat_app/rpc" log.StdoutHandler())
    )
...
logs after the account navigate to a new URL.
